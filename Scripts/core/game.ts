...
// Initialize and set properties for planets in the scene (please excuse arbitrary values)
...
function gameLoop(): void {
    ...
    // update camera position when zoomInOut control is used
